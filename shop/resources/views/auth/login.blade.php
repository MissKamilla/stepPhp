        ...
        <div><div><div class="card-body">
            <form method="POST" action="{{ route('login') }}" class='login-form'>
                ...
                <div class="form-group flex-row row">
                    ...
                    <div class="col-md-7">
                        <input id="password" type="password" class="lf--input form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
